...
<article>
    ...
    <section>
        ...
        <p>If you enrol in Agriculture, there is no need to declare a plan/major immediately. Both Crop Science and Food
            Science have a common first year; you can make your choice <em>after</em> you've been introduced to both
            topics.</p>
        <table>
            <thead>
            <tr>
        ...
        <p>The Faculty of Arts and Science requires students to
            <a href="https://www.queensu.ca/artsci/undergrad-students/plan-selection">declare a plan/major</a> once
            they have completed 24 units (or more). This typically occurs at the end of their first year.
        </p>
    </section>
    <?php print_footer(); ?>
</body>
